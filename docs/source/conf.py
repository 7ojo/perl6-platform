...
project = 'Platform'
copyright = '2017, Jarkko Haapalainen'
author = 'Jarkko Haapalainen'
...
latex_documents = [
    (master_doc, 'Platform.tex', 'Platform Documentation',
     'Jarkko Haapalainen', 'manual'),
]
...
man_pages = [
    (master_doc, 'platform', 'Platform Documentation',
     [author], 1)
]
